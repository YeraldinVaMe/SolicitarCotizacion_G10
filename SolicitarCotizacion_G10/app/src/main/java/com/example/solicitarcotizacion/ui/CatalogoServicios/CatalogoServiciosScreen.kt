...
@Composable
fun CatalogoServicios(navController: NavController, viewModel: CatalogoServicioViewModel, masterViewModel: MasterViewModel) {
...
@Composable
fun CatalogoPreview(){
    CatalogoServicios(rememberNavController(), CatalogoServicioViewModel(), MasterViewModel())
}
    ...
    TopLevel(modifier = modifier) {
        ...
        SSeguridad(modifier = Modifier
            ...
            Checkbox(
                ...
                onCheckedChange = {
                    viewModel.onOncheckBoxGuardiasChange(it)},
                modifier = Modifier.boxAlign(
                    alignment = Alignment.TopCenter,
                    offset = DpOffset(
                        x = 54.0.dp,
        ...
        BtnSolicitar(
            onbtnSolicitar = {
                masterViewModel.setSeguridad(oncheckBoxGuardias)
                masterViewModel.setLimpieza(oncheckBoxLimpieza)
                masterViewModel.setJardineria(oncheckBoxJardineria)
                navController.navigate(Screen.solicitarCotizacion.route) },
            modifier = Modifier
                .rowWeight(1.0f)
                .columnWeight(1.0f)
        ) {
