...
@Composable
fun Resumen(navController: NavController, viewModel: ResumenViewModel, masterViewModel: MasterViewModel){
...
fun ResumenView(){
    MaterialTheme {
        Resumen(rememberNavController(), ResumenViewModel(), MasterViewModel())
    }
}
