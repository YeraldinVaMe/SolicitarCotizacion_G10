...
@Composable
fun VerAreasComunes(navController: NavController, viewModel: VerAreasComunesViewModel, masterViewModel: MasterViewModel){
...
fun VerAreasComunesView(){
    MaterialTheme {
        VerAreasComunes(rememberNavController(), VerAreasComunesViewModel(), MasterViewModel())
    }
}
