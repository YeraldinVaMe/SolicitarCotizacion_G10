...
@Composable
fun VerPredio(navController: NavController, viewModel: VerPredioViewModel, masterViewModel: MasterViewModel){
    val image = painterResource(R.drawable.fondo2)

    val predio : PredioItem by masterViewModel.predioSelected.observeAsState(initial = PredioItem(
        correo =  "",
        descripcion =  "",
        direccion =  "",
        id_persona = 0,
    ...
    val NombrePrediotext : String = predio.descripcion
    val RUCtext : String = predio.ruc
    val Tipotext : String = viewModel.getInputContenedorTipotext()
    val CodPostaltext : String = predio.idubigeo
    val NumContactotext : String = predio.telefono
    val Correotext : String = predio.correo
    val Direcciontext : String = predio.direccion
...
fun VerPredioView(){
    MaterialTheme {
        VerPredio(rememberNavController(), VerPredioViewModel(), MasterViewModel())
    }
}
