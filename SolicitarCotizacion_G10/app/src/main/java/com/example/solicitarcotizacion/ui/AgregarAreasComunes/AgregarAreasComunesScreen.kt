...
@Composable
fun AgregarAreasComunes(navController: NavController, viewModel: AgregarAreasComunesViewModel, masterViewModel: MasterViewModel){
...
fun AgregarAreasComunesView(){
    MaterialTheme {
        AgregarAreasComunes(rememberNavController(), AgregarAreasComunesViewModel(), MasterViewModel())
    }
}
...
fun Class2(
    ...
    val inputCantAreas: String by viewModel.inputCantAreas.observeAsState("")
    RelayText(
